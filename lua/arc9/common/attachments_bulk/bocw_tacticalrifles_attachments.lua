...
ATT.Icon = Material("entities/bocw_atts/handles/type63_sasrjungle.png", "mips smooth")
...
ATT.Model = "models/weapons/arc9/atts/bocw_type63_handle_sasrjungle.mdl"
...
ARC9.LoadAttachment(ATT, "bocw_type63_handle_sasrjungle")
